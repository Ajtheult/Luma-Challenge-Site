          ...
          <Row>
            ...
            <Col>
              <Card style={{ width: "12rem" }}>
                <img variant="top" src={one} className="image-heights" />
            ...
            <Col>
              <Card style={{ width: "12rem" }}>
                <img variant="top" src={two} className="image-heights" />
                <Card.Body>
                  <Card.Title>Card Title</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make
            ...
            <Col>
              <Card style={{ width: "12rem" }}>
                <img variant="top" src={three} className="image-heights" />
                <Card.Body>
                  <Card.Title>Card Title</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make
            ...
            <Col>
              <Card style={{ width: "12rem" }}>
                <img variant="top" src={four} className="image-heights" />
                <Card.Body>
                  <Card.Title>Card Title</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make
            ...
            <Col>
              <Card style={{ width: "12rem" }}>
                <img variant="top" src={five} className="image-heights" />
                <Card.Body>
                  <Card.Title>Card Title</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make
            ...
            <Row className="second-row">
              <Col>
                <Card style={{ width: "12rem" }}>
                  <img variant="top" src={six} className="image-heights" />
                  <Card.Body>
                    <Card.Title>Card Title</Card.Title>
                    <Card.Text>
              ...
              <Col>
                <Card style={{ width: "12rem" }}>
                  <img variant="top" src={seven} className="image-heights" />
                  <Card.Body>
                    <Card.Title>Card Title</Card.Title>
                    <Card.Text>
                      Some quick example text to build on the card title and
